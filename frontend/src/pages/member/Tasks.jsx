...
const MemberTasks = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-display font-bold text-gray-900">My Tasks</h1>
        <p className="text-gray-600">Track and manage your assigned tasks</p>
      </div>

      <div className="glass-panel p-8">
        <h2 className="text-xl font-display font-semibold text-gray-900 mb-6">My Task Board</h2>
